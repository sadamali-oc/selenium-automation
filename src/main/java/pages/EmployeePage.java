...
public class EmployeePage {
    ...
    // Employee form
    private final By newEmployeeButton = By.id("addNewEmployee");
    private final By employeeModal = By.id("addStaffModel");
    private final By loader = By.id("loaderwrapper");

    // Basic employee details
    private final By title = By.id("employeeSalutations");
    private final By name = By.id("employeeName");
    private final By initials = By.id("empNameInitials");
    private final By firstName = By.id("empFirstName");
    private final By lastName = By.id("empLastName");
    private final By address = By.id("employeeAddress");
    private final By nic = By.id("employeeNic");
    private final By email = By.id("employeeEmail");
    private final By mobile = By.id("employeeMobile");
    private final By phone = By.id("employeePhone");
    private final By reference = By.id("employeeReference");
    private final By vehicleNo = By.id("employeevehicleNo");
    private final By employeeStatus = By.id("EmployeeStatus");
    private final By remark = By.id("employeeRemark");

    // Bank details
    private final By bankName = By.id("empBankName");
    private final By bankAccount = By.id("empBankAccount");
    ...
    // Employment details
    private final By designation = By.id("employeeDesignation");
    private final By epfNo = By.id("employeeEPFNo");
    private final By dateJoined = By.id("employeeDateJoined");
    private final By location = By.id("employeeLocation");
    private final By dateOfBirth = By.id("employeeDOB");

    // Other controls
    private final By employeeImage = By.id("file");
    private final By multipleLocationsButton = By.id("addItemRackNo");
    private final By saveButton = By.id("saveNewEmployeeBtn");
    ...
    public void clickNewEmployee() {
        ...
        WebElement button = wait.until(
                ExpectedConditions.elementToBeClickable(newEmployeeButton)
        );

        button.click();

        wait.until(
                ExpectedConditions.visibilityOfElementLocated(employeeModal)
        );
    ...
    public void selectEmployeeGroup() {
        ...
        WebElement group = wait.until(
                ExpectedConditions.elementToBeClickable(employeeGroupAdmin)
        );
    ...
    public void selectEmployeeStatus(String value) {
        ...
        WebElement field = wait.until(
                ExpectedConditions.elementToBeClickable(employeeStatus)
        );
    ...
    public void uploadEmployeeImage(String filePath) {
        ...
        WebElement fileInput = wait.until(
                ExpectedConditions.presenceOfElementLocated(employeeImage)
        );
    ...
    private void enterDateField(By locator, String value) {
